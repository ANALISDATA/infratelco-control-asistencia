...
MODULOS = [
    ...
    "backend.repositories.schedule_repository",
    "backend.repositories.attendance_repository",
    ...
    "backend.services.schedules.schedule_service",
    "backend.services.attendance.attendance_service",
    "backend.services.geolocation.location_service",
    "backend.services.geolocation.reverse_geocoding_service",
    "backend.services.geolocation.providers.nominatim_provider",
    ...
    "frontend.pages.admin_schedules_page",
    "frontend.pages.admin_attendance_page",
]
